...
const Page = (props: Props) => {
  ...
  return (
    <AdminProtected>
      <PageHead
        title='LearnX - Invoices | Admin Dashboard'
        description='Customer invoices and orders on LearnX platform.'
        keywords='Invoices, Transaction History, LearnX Admin, Adil Amjad LMS, Adil Amjad Project'
      />
