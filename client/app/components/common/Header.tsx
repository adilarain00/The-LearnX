        ...
        <div className={styles.sectionStyles.container}>
          <div className='w-full h-[80px] flex items-center justify-between'>
            <div className='relative inline-block'>
              <span className='absolute top-1/3 cursor-pointer left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[#9000ff] text-[70px] font-bold opacity-20'>
                X
              </span>
              <Link
                href={'/'}
            ...
            <div className='flex items-center gap-4'>
              ...
              {userData ? (
                ...
                <button
                  className='hidden 800px:block cursor-pointer text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-600 transition-colors'
              ...
              <div className='800px:hidden'>
                <button
                  className='p-2 cursor-pointer text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-600 transition-colors'
        ...
        {openSidebar && (
          <div className='fixed w-full h-screen top-0 left-0 z-[99999] bg-black/50 dark:bg-black/70'>
            <div className='w-[70%] fixed z-[999999999] h-screen bg-white dark:bg-slate-900 top-0 right-0 shadow-2xl'>
              <div
                className='p-4 flex justify-end cursor-pointer text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-600'
              ...
              <button
                onClick={() => setOpen(true)}
                className='flex items-center py-5 px-6 font-[400] text-[18px] text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-600 cursor-pointer transition-colors'
              >
