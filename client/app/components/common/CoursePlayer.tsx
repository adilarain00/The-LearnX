    ...
    return (
      ...
      >
        <div className='absolute inset-0 flex items-center justify-center'>
          <div className='flex flex-col items-center gap-6'>
            <div className='relative'>
              <div className='w-12 h-12 sm:w-16 sm:h-16 border-4 border-purple-200/30 rounded-full'></div>
              <div className='absolute top-0 left-0 w-12 h-12 sm:w-16 sm:h-16 border-4 border-purple-500 border-t-transparent rounded-full animate-spin'></div>
            </div>
        ...
        <div className='absolute inset-0 opacity-10'>
          <div className='absolute top-4 left-4 sm:top-10 sm:left-10 w-10 h-10 sm:w-20 sm:h-20 bg-purple-500 rounded-full blur-xl animate-pulse'></div>
