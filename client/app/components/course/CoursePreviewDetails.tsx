...
const CoursePreviewDetails = ({
  ...
  return (
    <div className={styles.sectionStyles.container}>
      <div className={styles.combineStyles('my-12')}>
              ...
              <div className='space-y-3'>
                {data?.prerequisites?.map((item: any, index: number) => (
                  <div key={index} className='flex items-start gap-3'>
                    <IoCheckmarkDoneOutline className='w-5 h-5 text-purple-600 dark:text-purple-400 mt-0.5 flex-shrink-0' />
                    <p className='text-sm text-slate-700 dark:text-slate-300'>
                      {item.title}
                    </p>
                  </div>
                          ...
                          <div className='flex gap-3 mt-4 ml-6' key={idx}>
                            ...
                            <div>
                              <div className='flex items-center gap-2'>
                                ...
                                <VscVerifiedFilled className='text-purple-500 ml-1 text-lg' />
                              </div>
                              <p className='text-slate-700 dark:text-slate-300 mt-1'>
                                {i.comment}
                              </p>
