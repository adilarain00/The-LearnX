        ...
        {tabList.map((text, index) => (
          <button
            ...
            className={styles.combineStyles(
              ...
              activeBar === index
                ? 'bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border-b-4 border-purple-600 dark:border-purple-400 shadow'
            ...
            {data[activeVideo]?.links?.length ? (
              data[activeVideo]?.links.map((item: any, index: number) => (
                <div className='mb-5' key={index}>
                  ...
                  <a
                    className='inline-block text-purple-600 dark:text-purple-400 pl-2 break-all'
                    href={item.url}
                    target='_blank'
