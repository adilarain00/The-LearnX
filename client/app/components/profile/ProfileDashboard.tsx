        ...
        <div className='flex-1'>
          ...
          {active === 3 && (
            <div className='w-full pl-7 px-2 800px:px-10 800px:pl-8'>
              <div className='w-full max-w-[1500px] mx-auto grid grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] 1500px:grid-cols-4 1500px:gap-[35px] mb-12 border-0'>
                {courses &&
              ...
              {courses.length === 0 && (
                <div
                  className={styles.combineStyles(
                    'flex flex-col items-center justify-center text-center  dark:bg-slate-800/40 dark:border-slate-700 mb-8'
                  )}
                >
                  <svg
                    className='w-12 h-12 mb-4 text-purple-400 dark:text-purple-500'
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
                  >
                  ...
                  <h2
                    className={styles.combineStyles(
                      ...
                      'mb-2 text-purple-600 dark:text-purple-400 font-Poppins'
                    )}
                  >
                    No Courses Yet
                  </h2>
