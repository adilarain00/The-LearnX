          ...
          <input
            ...
            className={styles.combineStyles(
              ...
              invalidError
                ...
                : 'border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 focus:border-purple-500 dark:focus:border-purple-400 focus:ring-purple-500/20'
            )}
            placeholder=''
            maxLength={1}
