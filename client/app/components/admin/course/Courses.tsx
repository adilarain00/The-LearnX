      ...
      renderCell: (params: any) => (
        <div className='flex items-center gap-2'>
          <Link href={`/admin/update-course/${params.row.id}`}>
            <button className='p-2 rounded-lg text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500/20'>
              <FiEdit2 size={16} />
            </button>
          </Link>
          <button
