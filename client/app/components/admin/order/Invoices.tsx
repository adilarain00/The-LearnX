...
const Invoices = ({ isDashboard }: Props) => {
  ...
  return (
    <div className={styles.combineStyles('min-h-screen')}>
      <div className='mb-8'>
        <h1 className={styles.titleStyles.h3}>
          Orders &{' '}
          <span className='text-purple-600 dark:text-purple-400'>Invoices</span>
        </h1>
        <p className={styles.titleStyles.subtitle}>
          Track and manage every customer order and transaction in one place.
        </p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
        ...
        >
          <div className='w-12 h-12 mx-auto mb-3 bg-purple-100 dark:bg-purple-900/20 rounded-lg flex items-center justify-center'>
            <MdShoppingCart className='w-8 h-8 text-purple-600 dark:text-purple-400' />
          </div>
