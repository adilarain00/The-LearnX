      ...
      renderCell: (params: any) => (
        <div className={`flex items-center ${isMobile ? 'gap-1' : 'gap-2'}`}>
          ...
          <a
            ...
            className={`${
              isMobile ? 'p-1.5' : 'p-2'
            } rounded-lg text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500/20`}
            title='Send email'
          >
                ...
                <div>
                  ...
                  <p className='text-slate-600 dark:text-slate-400 text-xs sm:text-sm lg:text-base'>
                    {isTeam
                      ...
                      : 'Manage platform users with full control and insights.'}
                  </p>
                </div>
            ...
            >
              <div className='p-4 sm:p-6'>
                <div className='flex items-center mb-4'>
                  <div className='p-2 sm:p-3 bg-purple-100 dark:bg-purple-900/30 rounded-full mr-3 sm:mr-4 flex-shrink-0'>
                    <AiOutlineUserAdd
                      className='text-purple-600 dark:text-purple-400'
                      size={isMobile ? 20 : 24}
                    />
