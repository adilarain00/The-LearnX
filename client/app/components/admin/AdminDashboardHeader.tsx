          ...
          <div className='w-full h-[80px] flex items-center justify-between'>
            ...
            <div className='flex items-center gap-4'>
                  ...
                  <div className='absolute top-12 right-0 w-[90vw] max-w-md sm:w-80 lg:w-96 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl z-[1000] overflow-hidden'>
                                ...
                                <div className='flex items-center gap-0.5 lg:gap-1 flex-shrink-0'>
                                  {!item.read && (
                                    <button
                                      ...
                                      title='Mark as read'
                                    >
                                      <MdMarkAsUnread className='w-3 h-3 lg:w-4 lg:h-4 text-slate-400 hover:text-purple-500' />
                                    </button>
                                  )}
                                </div>
                              </div>
                    ...
                    {notifications.length > 0 && (
                      <div className='p-2 lg:p-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50'>
                        <button
                          className='w-full text-center text-xs lg:text-sm text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium py-1.5 lg:py-2 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors'
              ...
              {user ? (
                ...
                <button
                  className='hidden 800px:block cursor-pointer text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-400 transition-colors'
        ...
        {sidebarOpen && (
          <div className='fixed w-full h-screen top-0 left-0 z-[99999] bg-black/50 dark:bg-black/70 800px:hidden'>
            <div className='w-[70%] fixed z-[999999999] h-screen bg-white dark:bg-slate-900 top-0 right-0 shadow-2xl'>
              <div
                className='p-4 flex justify-end cursor-pointer text-slate-700 dark:text-slate-300 hover:text-purple-600 dark:hover:text-purple-400'
