    ...
    <div className={styles.combineStyles()}>
      <div className='mb-6'>
        ...
        <p className={styles.titleStyles.subtitle}>
          Keep your FAQ section updated so users can easily access helpful
          answers.{' '}
        </p>
      </div>
            ...
            questions.map((q: any, index: number) => (
              <div
                ...
                className={styles.combineStyles(
                  'border border-slate-200 dark:border-slate-700 rounded-lg p-4 bg-gray-200 dark:bg-slate-800/50'
                )}
              >
