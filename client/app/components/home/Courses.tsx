    ...
    >
      <div className={styles.sectionStyles.container}>
        <div className='text-center mb-12 lg:mb-16'>
          <h1
            className={combineStyles(styles.titleStyles.h2, 'text-center mb-7')}
          >
            <span>
              Unlock{' '}
            ...
            <br />
            <span>Through Industry-Driven Courses</span>
          </h1>
          ...
          >
            Learn with depth, build real projects, and gain the expertise you
            need to create meaningful career opportunities.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <>
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mb-12 w-full max-w-[1500px] mx-auto'>
