export const buttonStyles = {
  ...
  primary:
    "bg-purple-600 hover:bg-purple-700 text-white shadow-sm hover:shadow-md focus:ring-purple-500/20",
  secondary:
    "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:border-purple-500 dark:hover:border-purple-400 shadow-sm hover:shadow-md focus:ring-purple-500/20",
  tertiary:
    "bg-transparent text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 focus:ring-purple-500/20",
...
export const sectionStyles = {
  ...
  backgroundpurple: "bg-purple-50 dark:bg-purple-900/10",
...
export const navStyles = {
  ...
  linkActive: "text-purple-600 dark:text-purple-400",
  linkDefault:
  ...
  brand:
    "text-[25px] font-Poppins font-[500] text-slate-900 dark:text-white hover:text-purple-600 dark:hover:text-purple-400 transition-colors",
...
export const utilityStyles = {
  ...
  borderAccent: "border-purple-200 dark:border-purple-700",
  ...
  avatarBorderActive: "border-2 border-purple-600 dark:border-purple-400",
