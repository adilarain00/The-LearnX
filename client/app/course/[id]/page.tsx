...
const Page = () => {
  ...
  return (
    <>
      <PageHead
        title='LearnX | Course Details'
        description='Explore this course on LearnX. Find details, curriculum, and more.'
        keywords='Course Details, Adil Amjad LMS, Adil Amjad Project'
      />
      {isLoading ? (
        <Loader />
      ) : (
